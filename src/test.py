...
goal = pygame.Rect(800, 600, 50, 50)
...
if os.path.exists('q_table1.npy'):
    q_table = np.load('q_table1.npy')
else:
...
for episode in range(episodes):
    ...
    while True: 
        ...
        if reward == 15:
            times += 1
            print('Success times: ',times)
        
        if reward == -5 or reward == 15:
